(function ($) {
    ...
    document.onclick = function (e) {
        var container = $(".categori-dropdown-active-large");
        if (!container.is(e.target) && container.has(e.target).length === 0 && !searchToggle.is(e.target) && searchToggle.has(e.target).length === 0) {
